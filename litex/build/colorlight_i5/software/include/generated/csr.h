...
/* SPIFLASH Registers */
#define CSR_SPIFLASH_BASE (CSR_BASE + 0x1800L)
#define CSR_SPIFLASH_PHY_CLK_DIVISOR_ADDR (CSR_BASE + 0x1800L)
#define CSR_SPIFLASH_PHY_CLK_DIVISOR_SIZE 1
#define CSR_SPIFLASH_MMAP_DUMMY_BITS_ADDR (CSR_BASE + 0x1804L)
#define CSR_SPIFLASH_MMAP_DUMMY_BITS_SIZE 1
#define CSR_SPIFLASH_MASTER_CS_ADDR (CSR_BASE + 0x1808L)
#define CSR_SPIFLASH_MASTER_CS_SIZE 1
#define CSR_SPIFLASH_MASTER_PHYCONFIG_ADDR (CSR_BASE + 0x180cL)
#define CSR_SPIFLASH_MASTER_PHYCONFIG_SIZE 1
#define CSR_SPIFLASH_MASTER_RXTX_ADDR (CSR_BASE + 0x1810L)
#define CSR_SPIFLASH_MASTER_RXTX_SIZE 1
#define CSR_SPIFLASH_MASTER_STATUS_ADDR (CSR_BASE + 0x1814L)
...
#define CSR_VIDEO_TERMINAL_VTG_BASE (CSR_BASE + 0x3000L)
#define CSR_VIDEO_TERMINAL_VTG_ENABLE_ADDR (CSR_BASE + 0x3000L)
#define CSR_VIDEO_TERMINAL_VTG_ENABLE_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_HRES_ADDR (CSR_BASE + 0x3004L)
#define CSR_VIDEO_TERMINAL_VTG_HRES_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_HSYNC_START_ADDR (CSR_BASE + 0x3008L)
#define CSR_VIDEO_TERMINAL_VTG_HSYNC_START_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_HSYNC_END_ADDR (CSR_BASE + 0x300cL)
#define CSR_VIDEO_TERMINAL_VTG_HSYNC_END_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_HSCAN_ADDR (CSR_BASE + 0x3010L)
#define CSR_VIDEO_TERMINAL_VTG_HSCAN_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_VRES_ADDR (CSR_BASE + 0x3014L)
#define CSR_VIDEO_TERMINAL_VTG_VRES_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_VSYNC_START_ADDR (CSR_BASE + 0x3018L)
#define CSR_VIDEO_TERMINAL_VTG_VSYNC_START_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_VSYNC_END_ADDR (CSR_BASE + 0x301cL)
#define CSR_VIDEO_TERMINAL_VTG_VSYNC_END_SIZE 1
#define CSR_VIDEO_TERMINAL_VTG_VSCAN_ADDR (CSR_BASE + 0x3020L)
